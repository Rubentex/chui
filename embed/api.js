;window.CloudflareApps=window.Eager=window.CloudflareApps||window.Eager||{};window.CloudflareApps=window.CloudflareApps||{};CloudflareApps.siteId="8c1c1c6232c2ff8e12d003c9f58fe30e";CloudflareApps.installs=CloudflareApps.installs||{};;(function(){'use strict'
...
return false}}());CloudflareApps.installs["fo3hrxtNTA92"]={appId:"lMxPPXVOqmoE",scope:{}};;CloudflareApps.installs["fo3hrxtNTA92"].options={"account":{"accountId":"lRwQFhgPtbh1","service":"googleanalytics","userId":"115668842366409005983"},"anonymizeIp":false,"id":"","organization":"113725161","social":false,"web-properties-for-113725161":"UA-113725161-1","webPropertySchemaNames":["web-properties-for-113725161"]};;if(CloudflareApps.matchPage(CloudflareApps.installs['fo3hrxtNTA92'].URLPatterns)){(function(){var options=CloudflareApps.installs['fo3hrxtNTA92'].options;var id;if(options.account&&options.organization){id=options["web-properties-for-"+options.organization];}else{id=(options.id||"").trim();}
if(!id){console.log("Cloudflare Google Analytics: Disabled. UA-ID not present.");return;}else if("fo3hrxtNTA92"==="preview"){console.log("Cloudflare Google Analytics: Enabled",id);}
